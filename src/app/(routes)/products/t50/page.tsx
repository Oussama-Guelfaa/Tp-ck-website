...
// Technical specifications for T50
...
// Integration capabilities for T50
const integrationCapabilities = [
  { name: "WMS Compatibility", value: "Compatible with all client WMS systems" },
  { name: "API Documentation", value: "Available for download" },
...
// Certifications for T50
const certifications = [
  { name: "UL Certification", value: "UL 1740 - Industrial Robots and Robotic Equipment, UL 508A" },
  { name: "CE Marking", value: "Machinery Directive 2006/42/EC, Low Voltage Directive 2014/35/EU" },
  { name: "ISO Compliance", value: "ISO 14001:2015, ISO 9001:2015, ISO 27001:2013" },
  { name: "Energy Rating", value: "EU Energy Efficiency Class A++, Energy Star Certified" },
  { name: "Safety Standards", value: "EN ISO 13849-1:2015, EN 62061:2005, IEC 61508, ANSI/RIA R15.06" },
];

export default function T50ProductPage() {
  return (
    <MainLayout>
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative w-full aspect-square max-w-lg mx-auto">
                <Image
                  src="/images/t50-machine.jpg"
                  alt="TP@CK T50 Machine"
                  fill
                  className="object-contain"
                />
                <div className="absolute -bottom-4 -left-4 bg-black px-4 py-2 rounded-lg shadow-lg z-10">
                  <p className="text-white font-semibold">500 units/hour</p>
                ...
                <div className="absolute -top-4 -right-4 bg-black px-4 py-2 rounded-lg shadow-lg z-10">
                  <p className="text-white font-semibold">4m x 1.5m</p>
                  <p className="text-xs text-gray-400">Industrial footprint</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="heading-lg mb-4">Key T50 Features</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              The flagship T50 model delivers enterprise-grade features designed for
              high-volume operations and maximum efficiency.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold">Maximum Throughput</h3>
              </div>
              <p className="text-gray-600">
                Industry-leading capacity of up to 500 units per hour with consistent
                quality and precision across varied product types and materials.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold">Enterprise Integration</h3>
              </div>
              <p className="text-gray-600">
                Seamless integration with all enterprise systems including ERP, WMS, WCS,
                and custom solutions with comprehensive API support.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold">Intelligent Operations</h3>
              </div>
              <p className="text-gray-600">
                Advanced AI-driven operation with real-time optimization, predictive maintenance,
                and business intelligence capabilities for strategic decision making.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold">Universal Material Support</h3>
              </div>
              <p className="text-gray-600">
                Handles all industrial packaging materials with automatic optimization
                for different product types, sizes, and protection requirements.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              See how the T50 has transformed operations for one of our clients.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="relative h-64 lg:h-auto">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center">
                  <div className="px-8">
                    <h3 className="text-2xl font-bold text-white">European Distribution GmbH</h3>
                    <p className="text-gray-300">Enterprise Logistics Transformation</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8">
                <div className="flex items-center mb-4">
                  <div className="flex -space-x-2 mr-4">
                    <Image
                      src="/images/company-logo-4.svg"
                      alt="European Distribution GmbH"
                      width={40}
                      height={40}
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Thomas Weber, Technical Director</p>
                  </div>
                </div>

                <blockquote className="text-lg text-gray-700 italic mb-6">
                  "The T50 system exceeded our throughput expectations. The dual-mode operation gives us flexibility to adapt to seasonal demand fluctuations without compromising on quality. The enterprise analytics have helped us identify optimization opportunities across our entire supply chain."
                </blockquote>

                <div className="space-y-4 mb-6">
                  <div className="flex items-start">
                    <div className="w-16 flex-shrink-0 font-bold">Challenge:</div>
                    <p className="text-gray-600">Scaling operations to meet seasonal demand spikes while maintaining quality</p>
                  </div>
                  <div className="flex items-start">
                    <div className="w-16 flex-shrink-0 font-bold">Solution:</div>
                    <p className="text-gray-600">Implemented T50 with enterprise integration and variable throughput optimization</p>
                  </div>
                  <div className="flex items-start">
                    <div className="w-16 flex-shrink-0 font-bold">Results:</div>
                    <p className="text-gray-600">
                      45% increase in peak throughput capacity<br />
                      22% reduction in operating costs<br />
                      99.8% packaging quality consistency
                    </p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Compare the T50 with other models in the TP@CK range to find the perfect solution for your business.
            </p>
          </div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-black text-white">
                  ...
                  <th className="py-4 px-6 text-center">T30</th>
              ...
              <tbody className="bg-white">
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-4 px-6 text-center">500 units/hour</td>
                </tr>
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-4 px-6 text-center">4m x 1.5m</td>
                </tr>
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-4 px-6 text-center">16A</td>
                </tr>
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-4 px-6 text-center">See technical documentation</td>
                </tr>
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-4 px-6 text-center">Wood, recycled plastic, aluminum, steel</td>
                </tr>
                <tr className="border-b border-gray-100">
