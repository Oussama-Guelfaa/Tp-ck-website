              ...
              >
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start">
                    ...
                    <p className="text-gray-600">Enhanced throughput for medium to high volume operations</p>
                  </div>
                  <div className="flex items-start">
                    <Check className="text-primary mr-3 mt-1 flex-shrink-0" />
                    <p className="text-gray-600">Dual-mode operation for maximum versatility</p>
                  </div>
                  <div className="flex items-start">
                    <Check className="text-primary mr-3 mt-1 flex-shrink-0" />
                    <p className="text-gray-600">Advanced analytics and predictive maintenance system</p>
                  </div>
                  <div className="flex items-start">
                    <Check className="text-primary mr-3 mt-1 flex-shrink-0" />
                    <p className="text-gray-600">Comprehensive certifications for international deployment</p>
                  </div>
                </div>
