...
import { Tabs } from "@/components/ui/tabs"; // Changed Tab to Tabs
import {
  ArrowRight,
  Check,
  Download,
...
// Technical specifications for T20
...
// Integration capabilities for T20
...
const certifications = [
  ...
  { name: "ISO Compliance", value: "ISO 14001:2015 (Environmental Management)" },
  { name: "Energy Rating", value: "EU Energy Efficiency Class A" },
  { name: "Safety Standards", value: "EN ISO 13849-1:2015, EN 62061:2005" },
];

export default function T20ProductPage() {
  return (
    <MainLayout>
      {/* Hero Section */}
            ...
            >
              <div className="relative w-full aspect-square max-w-lg mx-auto">
                ...
                <div className="absolute -top-4 -right-4 bg-black px-4 py-2 rounded-lg shadow-lg z-10">
                  <p className="text-xs text-gray-400">Compact footprint</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="heading-lg mb-4">Key T20 Features</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              The compact T20 model comes with essential features designed to optimize packaging
              operations for small to medium businesses.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold">Compact Design</h3>
              </div>
              <p className="text-gray-600">
                Space-efficient footprint of 2.4m x 1.6m makes the T20 perfect for facilities
                with limited floor space without compromising on performance.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold">IT Integration</h3>
              </div>
              <p className="text-gray-600">
                Seamless compatibility with all major WMS/WCS systems with pre-built connectors
                for industry-standard warehouse management solutions.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold">AI e-Connect</h3>
              </div>
              <p className="text-gray-600">
                Predictive maintenance system that monitors machine performance,
                identifies potential issues before they cause downtime, and extends operational life.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Fully certified for international markets with UL certification for the US,
                CE marking for Europe, and ISO compliance for global operations.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Detailed technical information about the T20 model to help you determine if it meets your operational requirements.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              See how the T20 has transformed operations for one of our clients.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl overflow-hidden shadow-md">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="relative h-64 lg:h-auto">
                <Image
                  src="/images/case-study-t20.jpg"
                  alt="Case Study T20 Implementation"
                  fill
                  className="object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center">
                  <div className="px-8">
                    <h3 className="text-2xl font-bold text-white">Global Logistics Inc.</h3>
                    <p className="text-gray-300">Warehouse Optimization Case Study</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Sarah Johnson, Operations Director</p>
                  </div>
                </div>

                <blockquote className="text-lg text-gray-700 italic mb-6">
                  "The TP@CK T20 has transformed our warehouse operations. The WMS integration was
                  seamless, and we've seen a 32% increase in packaging efficiency within the first
                  month. The system's compact footprint allowed us to optimize our floor space."
                </blockquote>

                <div className="space-y-4 mb-6">
                  <div className="flex items-start">
                    <div className="w-16 flex-shrink-0 font-bold">Challenge:</div>
                    <p className="text-gray-600">Limited warehouse space with increasing order volume</p>
                  </div>
                  <div className="flex items-start">
                    <div className="w-16 flex-shrink-0 font-bold">Solution:</div>
                    <p className="text-gray-600">Implemented the T20 with WMS integration</p>
                  </div>
                  <div className="flex items-start">
                    <div className="w-16 flex-shrink-0 font-bold">Results:</div>
                    <p className="text-gray-600">
                      32% increase in packaging efficiency<br />
                      18% reduction in material waste<br />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Compare the T20 with other models in the TP@CK range to find the perfect solution for your business.
            </p>
          </div>
